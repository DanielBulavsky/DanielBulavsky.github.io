...
TODO
	...
	Graphic - ? PixelArt || ? ASC-II Art || ? Isometric || ? Canvas || ? 3D (WebGL)
...
GAME HANDLE:
	...
	If cell busy, there are some options
		If it resource -> log it resource, it type and quantity
											if unit is selected -> gather resource
...
Also PLAYER can names TEMPLATE of ABILITIES he has chosen once, for easy re-use
...
WORK ORDER
write on readMe.js, and script.js what are you going TODO,
turn-on SHAYA LEBEUF
