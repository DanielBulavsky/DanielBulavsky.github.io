...
var interval = 19;
var startDate;
var buttonStart = document.getElementsByClassName('btn-start-stop');
buttonStart[0].addEventListener("click", handlerStart);

var buttonClear = document.getElementsByClassName('btn-clear');
buttonClear[0].addEventListener("click", handlerClear);

var buttonSplit = document.getElementsByClassName('btn-split');
buttonSplit[0].addEventListener("click", handlerSplit);

var timer = document.getElementsByClassName('hh-mm-ss');
var milli = document.getElementsByClassName('msec');
